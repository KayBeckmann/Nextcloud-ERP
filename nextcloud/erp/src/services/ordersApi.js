...
export async function updateOrderPosition(orderId, id, payload) {
	const { data } = await axios.put(generateOcsUrl('apps/erp/api/v1/orders/{orderId}/positions/{id}', { orderId, id }), payload)
	return data.ocs.data
}
